module.exports = [
"[project]/src/lib/swrFetcher.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$swrFetcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/swrFetcher.ts [app-ssr] (ecmascript)");
;
;
;
...
function useItemsSWR(tab, search, apiClient, token) {
    ...
    const swrFetcher = apiClient && token ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$swrFetcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSWRFetcher"])(apiClient) // 認証あり
     : tab === "all" ? async ()=>{
    ...
    const swr = swrKey !== null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(swrKey, swrFetcher ?? null, swrConfig) : {
        data: undefined,
        error: undefined,
        isLoading: false,
        mutate: ()=>{}
...
function Home() {
    ...
    const { apiClient, isAuthenticated, token, isLoading: isAuthLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSanctumAuth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    // -------------------------------
    // タブ & クエリ
    // -------------------------------
    ...
    // SWR
    // -------------------------------
    const { items, isLoading: isItemsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$itemService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useItemsSWR"])(currentTab, currentSearchQuery, effectiveApiClient, token);
...
//# sourceMappingURL=_ba9dad83._.js.map