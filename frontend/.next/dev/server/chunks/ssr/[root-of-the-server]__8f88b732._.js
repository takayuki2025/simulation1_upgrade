...
function LoginPage() {
    ...
    const { login, isAuthenticated, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSanctumAuth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        console.log("[LoginPage] Try login:", {
            email,
        ...
        try {
            ...
            const message = error?.message || error?.response?.data?.message || "ログインに失敗しました。もう一度お試しください。";
            setApiError(message);
        } finally{
            setIsSubmitting(false);
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f88b732._.js.map