...
function Home() {
    ...
    // 1. 認証フックから必要な状態を取得
    const { user, isLoading: isAuthLoading, isLoggingOut, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
   ...
   */ const fetchItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (tab, search)=>{
        ...
        try {
            ...
            if (responseData && Array.isArray(responseData.items)) {
                ...
                setImageRefreshKey((prev)=>prev + 1); // 画像リフレッシュ
            } else {
    ...
    }, // 依存配列に authenticatedFetch を追加し、useAuth の状態変更によってトークンが更新される度に再実行できるようにする
    [
        isAuthenticated,
        isLoggingOut,
        authenticatedFetch
...
//# sourceMappingURL=_01e79881._.js.map