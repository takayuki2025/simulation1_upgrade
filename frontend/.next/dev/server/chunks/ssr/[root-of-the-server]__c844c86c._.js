...
apiClient.interceptors.request.use((config)=>{
    ...
    if (token) {
        ...
        if (!(config.headers instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AxiosHeaders"])) {
            config.headers = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AxiosHeaders"](config.headers);
        }
...
============================================================ */ async function loginWithLaravel(idToken, name) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/api/login_or_register`, {
        id_token: idToken,
        name
    }, {
        withCredentials: true
...
function AuthProvider({ children }) {
    ...
    /* API Client は token がある時だけ生成 */ const sanctumApiClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
...
============================================================ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const unsub = auth.onAuthStateChanged(async (u)=>{
            if (!u) {
                ...
                setUser(null);
                setToken(null);
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiToken"].clear();
                setIsLoading(false);
                return;
            }
            setFirebaseUser(u);
...
============================================================ */ const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ({ email, password })=>{
        ...
        const result = await loginWithLaravel(idToken); // ← name は不要
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiToken"].set(result.token);
        setToken(result.token);
        const client = createSanctumApiClient(result.token);
        const me = await client.get("/user");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c844c86c._.js.map