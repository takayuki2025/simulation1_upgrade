        ...
        "Mypage.useCallback[fetchItems]": async ()=>{
            ...
            try {
                ...
                const normalized = rawItems.map({
                    "Mypage.useCallback[fetchItems].normalized": (raw)=>normalizeItem(raw)
                }["Mypage.useCallback[fetchItems].normalized"]).filter({
                    "Mypage.useCallback[fetchItems].normalized": (i)=>i !== null
                }["Mypage.useCallback[fetchItems].normalized"]);
                setItems(normalized);
            } catch (e) {
...
//# sourceMappingURL=_cf5148a8._.js.map