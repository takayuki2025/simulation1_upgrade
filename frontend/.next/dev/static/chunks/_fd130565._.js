...
function Home() {
    ...
    const { isLoading: isAuthLoading, isLoggingOut, isAuthenticated, apiClient } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSanctumAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    async function loadItems() {
        ...
        setLoading(true);
        try {
            const list = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$itemService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["itemService"].getItems({
                tab: currentTab,
...
_s(Home, "iseEpH/CXe+EESyavLerlfM7A9c=", false, function() {
    return [
...
//# sourceMappingURL=_fd130565._.js.map