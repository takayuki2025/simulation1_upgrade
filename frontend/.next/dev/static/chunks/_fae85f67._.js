...
class AuthService {
    ...
    // ★ login は「1つのオブジェクト」を受け取る
    async login({ email, password }) {
        const firebaseUser = await this.firebase.login(email, password);
        return this.issueLaravelTokens(firebaseUser);
    }
    ...
    async logout() {
        // ★ logout を Firebase 側にも実装する必要があるため firebase.logout を追加
...
function AuthProvider({ children }) {
    _s();
    const [authService, setAuthService] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [laravelApi, setLaravelApi] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            }["AuthProvider.useEffect.httpClient"]);
...
_s(AuthProvider, "XoGTN4xZ/mTdIdcgcEOeEk90wmM=");
_c = AuthProvider;
var _c;
...
//# sourceMappingURL=_fae85f67._.js.map