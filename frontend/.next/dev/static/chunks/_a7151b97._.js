...
async function loginWithLaravel(idToken) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${API_BASE_URL}/api/login_or_register`, {
        id_token: idToken
    });
    return data.token;
}
function AuthProvider({ children }) {
    ...
    const apiClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[apiClient]": ()=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiClient"])(token);
        }
    }["AuthProvider.useMemo[apiClient]"], [
        token
    ]);
            ...
            const unsub = auth.onAuthStateChanged({
                "AuthProvider.useEffect.unsub": async (u)=>{
                    ...
                    try {
                        ...
                        setToken(appToken);
                        const client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createApiClient"])(appToken);
    ...
    const isAuthenticated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[isAuthenticated]": ()=>!!token
...
_s(AuthProvider, "TJjz1B+8AgCeV0GLQP5so/Xz570=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_a7151b97._.js.map