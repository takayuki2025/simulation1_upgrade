...
"[project]/src/lib/swrFetcher.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const createSWRFetcher = (apiClient)=>async (url)=>{
        if (!apiClient) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$swrFetcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/swrFetcher.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
;
;
;
const API_BASE_URL = ("TURBOPACK compile-time value", "https://localhost:9000");
function useItemsSWR(tab, search, apiClient, token) {
    _s();
    ...
    console.log("[useItemsSWR] URL =", url, "tab=", tab, "apiClient=", !!apiClient, "token=", token);
    // SWR の key
    const swrKey = tab === "all" ? token ? [
        url,
        token
    ] : url // token があれば key に含める（キャッシュ分離）
     : apiClient && token ? [
        url,
        token
    ] : null;
    ...
    // fetcher: 優先順
    // - 認証情報がある（apiClient）なら apiClient を使う（Authorization ヘッダ送信）
    // - ない場合は素の axios で public API を叩く
    const swrFetcher = apiClient && token ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$swrFetcher$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSWRFetcher"])(apiClient) // 認証あり
     : tab === "all" ? async ()=>{
        ...
        return res.data;
    } : null; // mylist & no apiClient -> 取得しない
    const swrConfig = {
    ...
    const swr = swrKey !== null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(swrKey, swrFetcher ?? null, swrConfig) : {
        data: undefined,
        error: undefined,
        isLoading: false,
        mutate: ()=>{}
...
_s(useItemsSWR, "7xERTuQa/rCStZtEZdi0LgBAmUk=", false, function() {
    return [
...
function Home() {
    ...
    const { apiClient, isAuthenticated, token, isLoading: isAuthLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSanctumAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    // -------------------------------
    // タブ & クエリ
    // -------------------------------
    ...
    // -------------------------------
    // ★ これを修正！
    //   → すべて/allでもログインしていたら apiClient を渡すことで
    //      Authorizationヘッダが送られる！
    // -------------------------------
    const effectiveApiClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo[effectiveApiClient]": ()=>{
            if (apiClient && isAuthenticated) return apiClient;
            return null;
        }
    }["Home.useMemo[effectiveApiClient]"], [
        apiClient,
    ...
    // SWR
    // -------------------------------
    const { items, isLoading: isItemsLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$itemService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useItemsSWR"])(currentTab, currentSearchQuery, effectiveApiClient, token);
...
_s(Home, "VvQJ/cbV10U7pw/uEVEO3nEDJdg=", false, function() {
    return [
...
//# sourceMappingURL=_4d0700fc._.js.map