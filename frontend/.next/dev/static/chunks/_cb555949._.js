...
apiClient.interceptors.request.use((config)=>{
    ...
    if (token) {
        ...
        if (!(config.headers instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AxiosHeaders"])) {
            config.headers = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AxiosHeaders"](config.headers);
        }
...
============================================================ */ async function loginWithLaravel(idToken, name) {
    const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/api/login_or_register`, {
        id_token: idToken,
        name
    }, {
        withCredentials: true
...
function AuthProvider({ children }) {
    ...
    const sanctumApiClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AuthProvider.useMemo[sanctumApiClient]": ()=>{
...
============================================================ */ const reloadAuthToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[reloadAuthToken]": async ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiToken"].set(result.token);
            ...
            const unsub = auth.onAuthStateChanged({
                "AuthProvider.useEffect.unsub": async (u)=>{
                    if (!u) {
                        ...
                        setUser(null);
                        setToken(null);
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiToken"].clear();
                        setIsLoading(false);
                        return;
                    }
                    setFirebaseUser(u);
...
_s(AuthProvider, "kBGw8ZxL+tnsA9a14KqtPeTQko8=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_cb555949._.js.map