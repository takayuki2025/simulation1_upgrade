...
const useItemListSWR = ()=>{
    _s();
    const { user, apiClient, isLoading: authLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ui$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const { data, error, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(swrKey, fetcher);
    return {
        items: data?.items ?? [],
...
_s(useItemListSWR, "qALfZrUtThH19CK7uwfsUv12KpE=", false, function() {
    return [
...
function Home() {
    ...
    const { isAuthenticated, isLoading: authLoading, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ui$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    /* =========================
     🔑 タブ / 検索状態
  ========================= */ const currentTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
    ...
    /* =========================
     ...
     - auth 確定後に fetch
     - ログイン中は /items/public
  ========================= */ const { items, isLoading: itemsLoading, error } = isSearch ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$useItemSearchSWR$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useItemSearchSWR"])(currentSearchQuery) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$useItemListSWR$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useItemListSWR"])();
...
_s(Home, "x5FQxQZJyHDi/2uWnYqVOcTUs7o=", false, function() {
    return [
...
//# sourceMappingURL=_f59abdf8._.js.map