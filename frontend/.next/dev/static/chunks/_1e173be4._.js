...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useAuth.tsx [app-client] (ecmascript)"); // 認証と認証済みAxiosクライアントの提供元
;
...
function ProfilePage() {
    ...
    const { user: authUser, isAuthenticated, isLoading: isAuthLoading, logout, reloadAuthToken, apiClient } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    // -------------------- State --------------------
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // UI全体のローディング
    const [isFetching, setIsFetching] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // データ取得中の状態
    const [isRecovering, setIsRecovering] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // 401リカバリー中
   ...
   */ const fetchUserProfile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProfilePage.useEffect": ()=>{
            ...
            const needsPolling = isAuthenticated && apiClient && isVerificationRedirect && user && !user.email_verified_at && !isFetching;
            // 初回フェッチ
            ...
            if (needsPolling) {
                ...
                const startPolling = {
                    "ProfilePage.useEffect.startPolling": async ()=>{
                        setIsFetching(true); // ポーリング中はフェッチ中とする
                        setIsLoading(true); // UIをローディング状態に保つ
                        try {
                            let currentData = user;
                            while(isVerificationRedirect && currentData && !currentData.email_verified_at && attempt < MAX_ATTEMPTS){
                                attempt++;
                                console.log(`[Polling] Attempt ${attempt}/${MAX_ATTEMPTS}. Checking verification status...`);
                                if (attempt > 1) {
                                    // 2回目以降はインターバルを待つ
                                    await new Promise({
                                        "ProfilePage.useEffect.startPolling": (resolve)=>setTimeout(resolve, POLLING_INTERVAL)
                                    }["ProfilePage.useEffect.startPolling"]);
                                }
                                // APIから最新データを取得
                                const response = await apiClient.get("/api/mypage/profile");
                                const responseData = response.data;
                            ...
                            // ポーリング終了時の処理
                            if (isVerificationRedirect && attempt >= MAX_ATTEMPTS && !currentData?.email_verified_at) {
                                console.warn("⚠️ [Polling] Max attempts reached. Verification data not synchronized yet.");
                                setSuccessMessage("⚠️ メール認証データの反映に時間がかかっています。しばらくしてから再度アクセスするか、リロードしてください。");
                                // クエリをクリーンアップ
                                router.replace("/mypage/profile");
                            }
                            setIsLoading(false);
...
_s(ProfilePage, "zuEATvEg4M+z+bq1kzc4CoSV2DI=", false, function() {
    return [
...
//# sourceMappingURL=_1e173be4._.js.map