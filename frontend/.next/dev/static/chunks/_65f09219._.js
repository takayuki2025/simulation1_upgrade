...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-client] (ecmascript)"); // AxiosError, AxiosResponse を追加
...
function Home() {
    ...
    const { user, isLoading: isAuthLoading, isLoggingOut, isAuthenticated, apiClient, logout, reloadAuthToken } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])(); // useAuthから全ての必要な機能を取得
   ...
   */ const authenticatedFetchWithRetry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[authenticatedFetchWithRetry]": async (url, params)=>{
    ...
    }["Home.useCallback[authenticatedFetchWithRetry]"], [
        isAuthenticated,
        isLoggingOut,
        apiClient,
        logout,
   ...
   */ const fetchItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    }["Home.useCallback[fetchItems]"], // 依存配列: 認証状態とカスタムフェッチャーに依存
    [
        isAuthenticated,
        isLoggingOut,
...
_s(Home, "x/uiCNKW584rDh5+PW3SL1yBpdE=", false, function() {
    return [
