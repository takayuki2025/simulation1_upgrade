...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useAuth.tsx [app-client] (ecmascript)"); // useApiClientは不要になったため削除
...
function Home() {
    ...
    isLoading: isAuthLoading, isLoggingOut, isAuthenticated, apiClient: rawApiClient } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const fetchItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[fetchItems]": // currentToken引数を削除
        async (tab, search)=>{
            // 認証済みAxiosインスタンスの参照
            ...
            const client = apiClient && useAuthClient ? apiClient : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
    ...
    }["Home.useCallback[fetchItems]"], // 依存配列を更新: rawApiClient, isAuthenticated を追加
    [
        rawApiClient,
        isAuthenticated,
        isLoggingOut,
...
_s(Home, "oblOpVi81Tolw7zj09LGEF+xRus=", false, function() {
    return [
...
//# sourceMappingURL=_65f09219._.js.map