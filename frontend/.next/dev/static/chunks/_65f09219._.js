...
function Home() {
    ...
    const { user, token, isLoading: isAuthLoading, isLoggingOut, isAuthenticated } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const fetchItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[fetchItems]": async (tab, search, currentToken)=>{
            ...
            if (currentToken) {
                ...
                console.warn("[Fetch] User exists but token is null. Fetching new token.");
...
_s(Home, "vdU6ysU5dE/0IeEYwQ6OvH31wHQ=", false, function() {
    return [
