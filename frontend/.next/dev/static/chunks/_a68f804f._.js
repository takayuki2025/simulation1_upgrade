...
function RegisterPage() {
    ...
    // 🔥 Hexagonal Service
    const { register, isAuthenticated, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSanctumAuth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    // UI 状態
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (result.needsEmailVerification) {
                // Firebase側がメール送信済 → 確認待ちページへ
                router.push("/email/verify");
                return;
            } else {
                // すでに認証済みのメールアドレスなら即プロフィールへ
...
_s(RegisterPage, "YZ4+fnta2OEqflmsz6twNe4hiJc=", false, function() {
    return [
